...
export const OceanBackground: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <View style={{ flex: 1, backgroundColor: ocean.seaDeep }}>
    ...
    />
    {/* stacked waves */}
    <Svg height={160} width="100%" viewBox="0 0 375 160" style={{ position: "absolute", top: 0 }}>
      <Path d="M0,70 C70,110 140,30 220,70 C300,110 360,50 375,80 L375,0 L0,0 Z" fill="#fff" opacity={0.95} />
      <Path d="M0,95 C70,135 140,55 220,95 C300,135 360,75 375,105 L375,0 L0,0 Z" fill="#fff" opacity={0.75} />
    </Svg>
    {children}
  </View>
);
